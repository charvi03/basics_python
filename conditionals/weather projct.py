...
btn = Button(wn, text='Get Notification', font=7, fg='grey19', command=notification).place(relx=0.4, rely=0.75)
...
def getNotification():
    ...
    try:
        ...
        url = baseUrl + "appid=" + '3866c93e33665543d262b56240a3b0d4' + "&q=" + cityName
        ...
        mb.showerror('Error')  # show pop up message if any error occurred
